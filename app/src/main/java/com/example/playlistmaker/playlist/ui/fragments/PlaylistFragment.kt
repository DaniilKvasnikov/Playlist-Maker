...
import com.example.playlistmaker.playlist.ui.details.PlaylistDetailsFragment
    ...
    private fun setupRecyclerView() {
        playlistAdapter = PlaylistAdapter { playlist ->
            requireParentFragment().findNavController().navigate(
                R.id.action_mediaLibrary_to_playlistDetails,
                bundleOf(PlaylistDetailsFragment.ARG_PLAYLIST_ID to playlist.id)
            )
        }
